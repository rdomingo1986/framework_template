...
<head>
	...
	<link rel="stylesheet" href="<?= base_url();?>assets/plugins/toast/css/jquery.toast.min.css">
</head>
<body>
	...
	<script src="<?= base_url();?>assets/app/js/models/LoginModel.js"></script>
	<script src="<?= base_url();?>assets/app/js/controllers/LoginController.js"></script>
